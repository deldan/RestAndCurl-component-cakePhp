 ...
 *
 * @package    Api
 * @subpackage controller.components.curl
...
class CurlComponent extends Object
{
    ...
    */
    ...
    /**
     * SimpleCall function, Return a get request results
     *
     * @param string  $method
     * @param string  $url
     * @param array   $params
   ...
   /**
    * SimpleFtpGet function, Return a get request results
    *
    * @param string   $url
   ...
   /**
    * Post file function, Post file curl
    *
    * @param array   $params
    * @param array   $options
    * @return void
   ...
   /**
    * SetCookies function, Set cookies curl
    *
    * @param array   $params
    * @return mixed
    */
   ...
   /**
    * HttpHeader function, http header curl
    *
    * @param string   $header
   ...
   /**
    * HttpMethod function, http Method curl
    *
    * @param string   $method
    * @return void
    */
   ...
   /**
    * HttpLogin function, http login curl
    *
    * @param string   $username
    * @param string   $password
    * @param string   $type
   ...
   /**
    * proxyLogin function, proxy Login curl
    *
    * @param string   $username
    * @param string   $password
    * @return mixed
   ...
   /**
    * Ssl function, ssl curl
    *
    * @param string   $verify_peer
    ...
    */
    ...
    /**
     * Create function, Start a session from a URL
     *
     * @param string   $url
     * @return Curl
     */
    ...
    /**
     * Execute function, End a session and return the results
     *
     * @return mixed
     */
   ...
   /**
    * IsEnabled function, Curl init exist
    *
    * @return mixed
    */
   ...
   /**
    * DebugRequest function, Debug request curl
    *
    * @return array
    */
   ...
   /**
    * SetDefault function, set default curl
    *
    * @return void
    */
